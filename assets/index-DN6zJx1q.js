var se=Object.defineProperty;var ne=(t,e,s)=>e in t?se(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var w=(t,e,s)=>ne(t,typeof e!="symbol"?e+"":e,s);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function s(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=s(i);fetch(i.href,r)}})();class S extends Error{constructor(s,n,i,r){super(s);w(this,"line");w(this,"source");w(this,"rawContent");this.line=n,this.source=i,this.rawContent=r,this.name="ParseError"}}function ie(t){switch(t){case"user":return"user";case"assistant":return"assistant";case"system":return"system";case"progress":return"progress";case"summary":return"summary";case"file-history-snapshot":return"checkpoint";case"queue-operation":return"system";default:return"system"}}function oe(t){if(typeof t=="string")return{type:"text",text:t};if(typeof t!="object"||t===null)return null;const e=t;switch(e.type){case"text":return{type:"text",text:e.text??""};case"thinking":return{type:"thinking",thinking:e.thinking??"",signature:e.signature};case"tool_use":return{type:"tool_use",toolUseId:e.id??"",toolName:e.name??"",toolInput:e.input??{}};case"tool_result":return{type:"tool_result",toolUseId:e.tool_use_id??"",toolResult:typeof e.content=="string"?e.content:JSON.stringify(e.content??""),isError:e.is_error===!0};case"image":return e.source?{type:"image",mediaType:e.source.media_type??"image/png",mediaData:e.source.data??""}:null;case"document":return e.source?{type:"document",mediaType:e.source.media_type??"application/pdf",mediaData:e.source.data??""}:null;default:return"text"in e&&typeof e.text=="string"?{type:"text",text:e.text}:null}}function re(t){if(!(t!=null&&t.usage))return;const e=t.usage;return{inputTokens:e.input_tokens??0,outputTokens:e.output_tokens??0,cacheCreationInputTokens:e.cache_creation_input_tokens,cacheReadInputTokens:e.cache_read_input_tokens}}function O(t,e="claude"){var c;const s=ie(t.type),n=[];let i;if(t.message){const a=t.message.content;if(typeof a=="string")i=a,n.push({type:"text",text:a});else if(Array.isArray(a)){for(const u of a){const p=oe(u);p&&n.push(p)}const l=n.filter(u=>u.type==="text");l.length>0&&(i=l.map(u=>u.text).join(`
`))}}t.type==="summary"&&t.summary&&(i=t.summary,n.length===0&&n.push({type:"text",text:t.summary}));let r;t.timestamp?r=new Date(t.timestamp):r=new Date;const o={uuid:t.uuid??`entry-${Date.now()}-${Math.random().toString(36).slice(2)}`,parentUuid:t.parentUuid??void 0,role:s,timestamp:r,source:e,contentBlocks:n,text:i,model:(c=t.message)==null?void 0:c.model,usage:re(t.message),gitBranch:t.gitBranch,cwd:t.cwd,isCheckpoint:t.type==="file-history-snapshot",isSidechain:t.isSidechain,metadata:{}};return t.sessionId&&(o.metadata.sessionId=t.sessionId),t.version&&(o.metadata.version=t.version),t.agentId&&(o.metadata.agentId=t.agentId),t.error&&(o.metadata.error=t.error),t.isApiErrorMessage&&(o.metadata.isApiErrorMessage=t.isApiErrorMessage),t.stopReason&&(o.metadata.stopReason=t.stopReason),t.requestId&&(o.metadata.requestId=t.requestId),t.permissionMode&&(o.metadata.permissionMode=t.permissionMode),t.thinkingMetadata&&(o.metadata.thinkingMetadata=t.thinkingMetadata),t.status&&(o.metadata.progressStatus=t.status),Object.keys(o.metadata).length===0&&delete o.metadata,o}function ae(t,e){const s=[];let n=0;const i=t.split(`
`);for(let r=0;r<i.length;r++){const o=i[r].trim();if(o)try{const c=JSON.parse(o);s.push(c)}catch{{n++;continue}}}return{entries:s,skipped:n}}function ce(t){if(typeof t!="string")return!1;const e=t.trim().split(`
`)[0];if(!e)return!1;try{const s=JSON.parse(e);return typeof s=="object"&&s!==null&&"type"in s&&["user","assistant","system","progress","file-history-snapshot","summary","queue-operation"].includes(s.type)}catch{return!1}}function N(t,e){var y,h;const s=t.filter(d=>d.role==="user"||d.role==="assistant"),n=s[0]??t[0],i=s[s.length-1]??t[t.length-1];let r;if(n&&i){const d=n.timestamp.getTime(),b=i.timestamp.getTime();!isNaN(d)&&!isNaN(b)&&b>d&&(r=b-d)}const o=t.find(d=>d.role==="assistant"&&d.model),c=o==null?void 0:o.model,a={inputTokens:0,outputTokens:0,cacheCreationInputTokens:0,cacheReadInputTokens:0};for(const d of t)d.usage&&(a.inputTokens+=d.usage.inputTokens??0,a.outputTokens+=d.usage.outputTokens??0,a.cacheCreationInputTokens+=d.usage.cacheCreationInputTokens??0,a.cacheReadInputTokens+=d.usage.cacheReadInputTokens??0);const l=(y=n==null?void 0:n.metadata)==null?void 0:y.sessionId,u=t.find(d=>d.role==="user"),p=(h=u==null?void 0:u.text)==null?void 0:h.slice(0,200),g=t.filter(d=>d.role==="summary"&&d.text),v=g.length>0?g[g.length-1].text:void 0;let m=e??"Claude Code Session";return l?m=`Session ${l.slice(0,8)}...`:p&&(m=p.slice(0,50)+(p.length>50?"...":"")),{id:l??`session-${Date.now()}`,title:m,source:"claude",entryCount:t.length,createdAt:n==null?void 0:n.timestamp,modifiedAt:i==null?void 0:i.timestamp,model:c,gitBranch:n==null?void 0:n.gitBranch,projectPath:n==null?void 0:n.cwd,durationMs:r,totalUsage:a,firstPrompt:p,summary:v}}function le(t){return{source:"claude",canParse(e){return ce(e)},parse(e,s){if(typeof e!="string")throw new S("Claude parser expects string content",void 0,"claude");const{entries:n,skipped:i}=ae(e),r=n.map(a=>O(a,"claude")),o=N(r,s),c=[];return i>0&&c.push(`Skipped ${i} invalid JSON line(s)`),{session:{meta:o,entries:r},warnings:c.length>0?c:void 0,skippedCount:i>0?i:void 0}},parseMetadata(e,s){if(typeof e!="string")throw new S("Claude parser expects string content",void 0,"claude");const n=e.split(`
`).filter(c=>c.trim()),i=[...n.slice(0,50),...n.slice(-10)],r=[];for(const c of i)try{const a=JSON.parse(c);r.push(O(a,"claude"))}catch{}const o=N(r,s);return o.entryCount=n.length,o}}}const de=le();function ue(t){if(typeof t!="string")return!1;try{const e=t.split(`
`);for(const s of e){const n=s.trim();if(!n)continue;const i=JSON.parse(n);return typeof i=="object"&&i!==null&&typeof i.role=="string"&&!("uuid"in i)&&!("type"in i)?["user","assistant","tool","system","_checkpoint","_usage"].includes(i.role):!1}return!1}catch{return!1}}function me(t){switch(t){case"user":return"user";case"assistant":return"assistant";case"tool":return"tool";case"system":return"system";case"_checkpoint":return"checkpoint";case"_usage":return"system";default:return"system"}}function D(t){if(t==null)return null;if(typeof t=="string")return{type:"text",text:t};if(typeof t!="object")return null;const e=t;switch(e.type){case"text":return{type:"text",text:e.text??""};case"thinking":case"think":return{type:"thinking",thinking:e.thinking??e.think??"",signature:e.signature};case"tool_result":{let n="";return typeof e.content=="string"?n=e.content:Array.isArray(e.content)&&(n=e.content.filter(i=>typeof i=="object"&&i!==null).map(i=>i.text??"").filter(Boolean).join("")),{type:"tool_result",toolUseId:e.tool_use_id??"",toolResult:n,isError:e.is_error??!1}}default:return"text"in e&&typeof e.text=="string"?{type:"text",text:e.text}:null}}function pe(t,e){const s=t.role;if(!s||s==="_usage")return null;const n={uuid:`L${e}`,role:me(s),timestamp:t.timestamp?new Date(t.timestamp*1e3):new Date,source:"kimi",contentBlocks:[],metadata:{}};if(s==="_checkpoint")return n.isCheckpoint=!0,n;switch(s){case"user":if(typeof t.content=="string")n.text=t.content,n.contentBlocks=[{type:"text",text:t.content}];else if(Array.isArray(t.content)){const i=t.content.map(D).filter(r=>r!==null);n.contentBlocks=i,n.text=H(i)}break;case"assistant":if(Array.isArray(t.content)){const i=t.content.map(D).filter(r=>r!==null);n.contentBlocks=i,n.text=H(i)}if(Array.isArray(t.tool_calls))for(const i of t.tool_calls){let r="",o={};if(i.function){if(r=i.function.name,i.function.arguments)try{o=JSON.parse(i.function.arguments)}catch{o=i.function.arguments}}else r=i.name??"",o=i.input??{};n.contentBlocks.push({type:"tool_use",toolUseId:i.id,toolName:r,toolInput:o})}break;case"tool":{let i="";typeof t.content=="string"?i=t.content:Array.isArray(t.content)&&(i=t.content.filter(r=>typeof r=="object"&&r!==null).map(r=>r.text??"").filter(Boolean).join("")),n.contentBlocks=[{type:"tool_result",toolUseId:t.tool_call_id??"",toolResult:i,isError:!1}];break}case"system":typeof t.content=="string"&&(n.text=t.content,n.contentBlocks=[{type:"text",text:t.content}]);break}return t.usage&&(n.usage={inputTokens:t.usage.input_tokens??0,outputTokens:t.usage.output_tokens??0}),n}function H(t){return t.filter(e=>e.type==="text").map(e=>e.text).filter(Boolean).join(`
`)}function z(t,e={}){const{skipInvalidLines:s=!0}=e,n=t.split(`
`),i=[];let r=0,o=0;for(const c of n){const a=c.trim();if(a){o++;try{const l=JSON.parse(a),u=pe(l,o);u&&i.push(u)}catch(l){if(s)r++;else throw new S(`Invalid JSON on line ${o}: ${l instanceof Error?l.message:String(l)}`)}}}return{entries:i,skipped:r}}function J(t){const e={id:`kimi-${Date.now()}`,title:"Kimi Session",source:"kimi",entryCount:t.length},s=t.find(o=>o.role==="user");s!=null&&s.text&&(e.firstPrompt=s.text.length>50?s.text.slice(0,50)+"...":s.text);const n=t.filter(o=>o.timestamp);if(n.length>=2){const o=n[0].timestamp,c=n[n.length-1].timestamp;e.durationMs=c.getTime()-o.getTime()}let i=0,r=0;for(const o of t)o.usage&&(i+=o.usage.inputTokens,r+=o.usage.outputTokens);return(i>0||r>0)&&(e.totalUsage={inputTokens:i,outputTokens:r}),e}function fe(t={}){return{source:"kimi",canParse(e){return ue(e)},parse(e){if(typeof e!="string")throw new S("Kimi parser expects string content");const{entries:s,skipped:n}=z(e,t),o={session:{meta:J(s),entries:s},warnings:[],skippedCount:n};return n>0&&o.warnings.push(`Skipped ${n} invalid JSON line(s)`),o},parseMetadata(e){if(typeof e!="string")throw new S("Kimi parser expects string content");const{entries:s}=z(e,{...t,skipInvalidLines:!0});return J(s)}}}const ge=fe();function he(t){if(typeof t!="string")return!1;try{const e=JSON.parse(t);return typeof e=="object"&&e!==null&&"sessionId"in e&&Array.isArray(e.messages)}catch{return!1}}function V(t){try{const e=JSON.parse(t),s=[];for(const i of e.messages){const r=i.timestamp?new Date(i.timestamp):new Date;if(i.type==="user")s.push({uuid:i.id??`msg-${Date.now()}-${Math.random()}`,role:"user",source:"gemini",timestamp:r,text:i.content,contentBlocks:i.content?[{type:"text",text:i.content}]:[]});else if(i.type==="gemini"){const o=[];if(i.thoughts)for(const a of i.thoughts)o.push({type:"thinking",thinking:`[${a.subject}] ${a.description}`});if(i.content&&o.push({type:"text",text:i.content}),i.toolCalls)for(const a of i.toolCalls)o.push({type:"tool_use",toolUseId:a.id,toolName:a.name,toolInput:a.args});const c=i.tokens?{inputTokens:i.tokens.input,outputTokens:i.tokens.output,thinkingTokens:i.tokens.thoughts,serverToolUse:i.tokens.tool}:void 0;if(s.push({uuid:i.id??`msg-${Date.now()}-${Math.random()}`,role:"assistant",source:"gemini",timestamp:r,model:i.model,usage:c,contentBlocks:o,text:i.content}),i.toolCalls){for(const a of i.toolCalls)if(a.result)for(const l of a.result){let u="";const p=l.functionResponse.response;if(p&&"output"in p){const g=p.output;u=typeof g=="string"?g:JSON.stringify(g)}else u=JSON.stringify(p);s.push({uuid:l.functionResponse.id??`res-${Date.now()}-${Math.random()}`,role:"tool",source:"gemini",timestamp:r,contentBlocks:[{type:"tool_result",toolUseId:a.id,toolResult:u,isError:!1}]})}}}}return{session:{meta:ye(e,s),entries:s}}}catch(e){throw new S(`Failed to parse Gemini JSON: ${e instanceof Error?e.message:String(e)}`,void 0,"gemini")}}function ye(t,e){const s=e.find(c=>c.role==="user"),n=s==null?void 0:s.text;let i=0,r=0;for(const c of e)c.usage&&(i+=c.usage.inputTokens,r+=c.usage.outputTokens);const o=t.startTime&&t.lastUpdated?new Date(t.lastUpdated).getTime()-new Date(t.startTime).getTime():void 0;return{id:t.sessionId,source:"gemini",title:n?n.slice(0,50)+(n.length>50?"...":""):"Gemini Session",entryCount:e.length,createdAt:t.startTime?new Date(t.startTime):void 0,modifiedAt:t.lastUpdated?new Date(t.lastUpdated):void 0,durationMs:o,totalUsage:{inputTokens:i,outputTokens:r},firstPrompt:n==null?void 0:n.slice(0,200)}}function ve(t){return{source:"gemini",canParse(e){return he(e)},parse(e){if(typeof e!="string")throw new S("Gemini parser expects string content");return V(e)},parseMetadata(e){if(typeof e!="string")throw new S("Gemini parser expects string content");return V(e).session.meta}}}const be=ve();class xe{constructor(){w(this,"parsers",new Map);this.register(de),this.register(ge),this.register(be)}register(e){this.parsers.set(e.source,e)}unregister(e){this.parsers.delete(e)}get(e){return this.parsers.get(e)}getSources(){return[...this.parsers.keys()]}canParse(e){for(const s of this.parsers.values())if(s.canParse(e))return!0;return!1}detect(e){for(const s of this.parsers.values())if(s.canParse(e))return s}parse(e,s){const n=this.detect(e);if(!n)throw new S("No parser found for content format");return n.parse(e,s)}parseMetadata(e,s){const n=this.detect(e);if(!n)throw new S("No parser found for content format");return n.parseMetadata?n.parseMetadata(e,s):n.parse(e,s).session.meta}}new xe;class W extends Error{constructor(s,n,i){super(s);w(this,"statusCode");w(this,"response");this.statusCode=n,this.response=i,this.name="ThinktAPIError"}}class q extends Error{constructor(s,n){super(s);w(this,"originalError");this.originalError=n,this.name="ThinktNetworkError"}}const ke={baseUrl:"http://localhost:8784",apiVersion:"/api/v1",timeout:3e4};function f(t,e,s,n){let i=`${t}${e}${s}`;if(n&&Object.keys(n).length>0){const r=new URLSearchParams;for(const[c,a]of Object.entries(n))a!=null&&r.append(c,String(a));const o=r.toString();o&&(i+=`?${o}`)}return i}class $e{constructor(e){w(this,"config");this.config={...ke,...e}}setConfig(e){this.config={...this.config,...e}}getConfig(){return{...this.config}}async fetchWithTimeout(e,s={},n){const i=new AbortController,r=setTimeout(()=>i.abort(),this.config.timeout),o=n?AbortSignal.any([i.signal,n]):i.signal,c=this.config.fetch??fetch;try{const a={};this.config.token&&(a.Authorization=`Bearer ${this.config.token}`);const l=await c(e,{...s,signal:o,headers:{Accept:"application/json",...a,...s.headers}});if(clearTimeout(r),!l.ok){let u;try{u=await l.json()}catch{}throw new W((u==null?void 0:u.message)||`HTTP ${l.status}: ${l.statusText}`,l.status,u)}return await l.json()}catch(a){throw clearTimeout(r),a instanceof W?a:a instanceof Error&&a.name==="AbortError"?n!=null&&n.aborted?a:new q(`Request timeout after ${this.config.timeout}ms`,a):new q(a instanceof Error?a.message:"Network error",a)}}async getSources(){const e=f(this.config.baseUrl,this.config.apiVersion,"/sources");return(await this.fetchWithTimeout(e)).sources??[]}async getProjects(e,s){const n=f(this.config.baseUrl,this.config.apiVersion,"/projects",{source:e,include_deleted:s!=null&&s.includeDeleted?"true":void 0});return(await this.fetchWithTimeout(n,{},s==null?void 0:s.signal)).projects??[]}async getSessions(e,s,n){const i=encodeURIComponent(e),r=s==null?void 0:s.trim().toLowerCase(),o=r?`/projects/${encodeURIComponent(r)}/${i}/sessions`:`/projects/${i}/sessions`,c=f(this.config.baseUrl,this.config.apiVersion,o);return(await this.fetchWithTimeout(c,{},n)).sessions??[]}async getSession(e,s){const n=encodeURIComponent(e),i=f(this.config.baseUrl,this.config.apiVersion,`/sessions/${n}`,{limit:s==null?void 0:s.limit,offset:s==null?void 0:s.offset}),r=await this.fetchWithTimeout(i,{},s==null?void 0:s.signal);return{meta:r.meta,entries:r.entries??[],total:r.total??0,has_more:r.has_more??!1}}async getSessionMetadata(e,s){const n=encodeURIComponent(e),i={limit:s==null?void 0:s.limit,offset:s==null?void 0:s.offset,sort_by:s==null?void 0:s.sortBy};s!=null&&s.excludeRoles&&s.excludeRoles.length>0&&(i.exclude_roles=s.excludeRoles.join(",")),(s==null?void 0:s.summaryOnly)!==void 0&&(i.summary_only=s.summaryOnly?"true":"false");const r=f(this.config.baseUrl,this.config.apiVersion,`/sessions/${n}/metadata`,i);return await this.fetchWithTimeout(r)}async openIn(e,s){const n=f(this.config.baseUrl,this.config.apiVersion,"/open-in"),i=await this.fetchWithTimeout(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({app:e,path:s})});if(i.error)throw new Error(i.error)}async getOpenInApps(){const e=f(this.config.baseUrl,this.config.apiVersion,"/open-in/apps");return await this.fetchWithTimeout(e)}async search(e){const s={q:e.query,project:e.project,source:e.source,limit:e.limit,limit_per_session:e.limitPerSession};e.caseSensitive&&(s.case_sensitive="true"),e.regex&&(s.regex="true");const n=f(this.config.baseUrl,this.config.apiVersion,"/search",s);return await this.fetchWithTimeout(n,{},e.signal)}async semanticSearch(e){const s={q:e.query,project:e.project,source:e.source,limit:e.limit,max_distance:e.maxDistance};e.diversity&&(s.diversity="true");const n=f(this.config.baseUrl,this.config.apiVersion,"/semantic-search",s);return await this.fetchWithTimeout(n,{},e.signal)}async getResumeCommand(e){const s=encodeURIComponent(e),n=f(this.config.baseUrl,this.config.apiVersion,`/sessions/${s}/resume`);return await this.fetchWithTimeout(n)}async execResumeSession(e){const s=encodeURIComponent(e),n=f(this.config.baseUrl,this.config.apiVersion,`/sessions/${s}/resume`);return await this.fetchWithTimeout(n,{method:"POST"})}async getIndexerHealth(){const e=f(this.config.baseUrl,this.config.apiVersion,"/indexer/health");return await this.fetchWithTimeout(e)}async getIndexerStatus(){const e=f(this.config.baseUrl,this.config.apiVersion,"/indexer/status");return await this.fetchWithTimeout(e)}async getInfo(){const e=f(this.config.baseUrl,this.config.apiVersion,"/info");return await this.fetchWithTimeout(e)}async getStats(){const e=f(this.config.baseUrl,this.config.apiVersion,"/stats");return await this.fetchWithTimeout(e)}async getTeams(){const e=f(this.config.baseUrl,this.config.apiVersion,"/teams");return(await this.fetchWithTimeout(e)).teams??[]}async getTeam(e){const s=encodeURIComponent(e),n=f(this.config.baseUrl,this.config.apiVersion,`/teams/${s}`);return await this.fetchWithTimeout(n)}async getTeamMemberMessages(e,s){const n=encodeURIComponent(e),i=encodeURIComponent(s),r=f(this.config.baseUrl,this.config.apiVersion,`/teams/${n}/members/${i}/messages`);return(await this.fetchWithTimeout(r)).messages??[]}async getTeamTasks(e){const s=encodeURIComponent(e),n=f(this.config.baseUrl,this.config.apiVersion,`/teams/${s}/tasks`);return(await this.fetchWithTimeout(n)).tasks??[]}async getThemes(){const e=f(this.config.baseUrl,this.config.apiVersion,"/themes");return await this.fetchWithTimeout(e)}async*streamSessionEntries(e,s=100,n){let i=0,r=!0;for(;r;){const o=await this.getSession(e,{limit:s,offset:i,signal:n});for(const c of o.entries)yield c;if(r=o.has_more,i+=o.entries.length,o.entries.length===0)break}}async getAllSessionEntries(e,s=100,n){const i=[];for await(const r of this.streamSessionEntries(e,s,n))i.push(r);return i}}function R(t){return t==="thinkt"?"thinkt":t==="codex"?"codex":t==="copilot"?"copilot":t==="kimi"?"kimi":t==="gemini"?"gemini":t==="qwen"?"qwen":"claude"}function _e(t){switch(t){case"user":return"user";case"assistant":return"assistant";case"tool":return"tool";case"system":return"system";case"summary":return"summary";case"progress":return"progress";case"checkpoint":return"checkpoint";default:return"assistant"}}function Te(t){switch(t.type??"text"){case"text":return{type:"text",text:t.text??""};case"thinking":return{type:"thinking",thinking:t.thinking??"",signature:t.signature};case"tool_use":return{type:"tool_use",toolUseId:t.tool_use_id??"",toolName:t.tool_name??"unknown",toolInput:t.tool_input??{}};case"tool_result":return{type:"tool_result",toolUseId:t.tool_use_id??"",toolResult:t.tool_result??"",isError:t.is_error??!1};case"image":return{type:"image",mediaType:t.media_type??"image/png",mediaData:t.media_data??""};case"document":return{type:"document",mediaType:t.media_type??"application/pdf",mediaData:t.media_data??"",filename:void 0};default:return{type:"text",text:t.text??""}}}function we(t){return{id:t.id??"",name:t.name??"",path:t.path??"",displayPath:t.display_path,sessionCount:t.session_count??0,lastModified:t.last_modified?new Date(t.last_modified):void 0,source:R(t.source),workspaceId:t.workspace_id,sourceBasePath:t.source_base_path,pathExists:t.path_exists??!0}}function F(t){return{id:t.id??"unknown",projectPath:t.project_path,fullPath:t.full_path,firstPrompt:t.first_prompt,summary:t.summary,entryCount:t.entry_count??0,fileSize:t.file_size,createdAt:t.created_at?new Date(t.created_at):void 0,modifiedAt:t.modified_at?new Date(t.modified_at):void 0,gitBranch:t.git_branch,model:t.model,source:R(t.source),workspaceId:t.workspace_id,chunkCount:t.chunk_count,title:t.first_prompt?t.first_prompt.slice(0,60)+(t.first_prompt.length>60?"...":""):t.id??"Untitled Session"}}function G(t){var n;const e=((n=t.content_blocks)==null?void 0:n.map(Te))??[],s={};return t.metadata&&Object.assign(s,t.metadata),t.workspace_id&&(s.workspaceId=t.workspace_id),{uuid:t.uuid??`entry-${Date.now()}-${Math.random().toString(36).slice(2)}`,parentUuid:t.parent_uuid??void 0,role:_e(t.role),timestamp:t.timestamp?new Date(t.timestamp):new Date,source:R(t.source),contentBlocks:e,text:t.text??e.filter(i=>i.type==="text").map(i=>i.text).join(`
`),model:t.model,usage:t.usage?{inputTokens:t.usage.input_tokens??0,outputTokens:t.usage.output_tokens??0,cacheCreationInputTokens:t.usage.cache_creation_input_tokens,cacheReadInputTokens:t.usage.cache_read_input_tokens}:void 0,gitBranch:t.git_branch,cwd:t.cwd,isCheckpoint:t.is_checkpoint??!1,isSidechain:t.is_sidechain??!1,agentId:t.agent_id,sourceAgentId:t.source_agent_id,metadata:Object.keys(s).length>0?s:void 0}}function Se(t){return t==="thinkt"?"thinkt":t==="codex"?"codex":t==="copilot"?"copilot":t==="kimi"?"kimi":t==="gemini"?"gemini":t==="qwen"?"qwen":"claude"}class Ce{constructor(e){w(this,"_api");this._api=new $e(e)}get api(){return this._api}setConfig(e){this._api.setConfig(e)}getConfig(){return this._api.getConfig()}async getSources(){return this._api.getSources()}async getProjects(e,s){return(await this._api.getProjects(e,s)).map(we)}async getSessions(e,s,n){return(await this._api.getSessions(e,s,n)).map(F)}async getSession(e,s){const n=await this._api.getSession(e,s);return{meta:F(n.meta),entries:n.entries.map(G),total:n.total,hasMore:n.has_more}}async getSessionMetadata(e,s){const n=await this._api.getSessionMetadata(e,s),i=n.meta;return{meta:{id:(i==null?void 0:i.id)??"unknown",fullPath:i==null?void 0:i.path,entryCount:n.total_entries??0,createdAt:i!=null&&i.created_at?new Date(i.created_at):void 0,modifiedAt:i!=null&&i.modified_at?new Date(i.modified_at):void 0,gitBranch:i==null?void 0:i.git_branch,model:i==null?void 0:i.model,source:Se(i==null?void 0:i.source),title:(i==null?void 0:i.id)??"Session Metadata"},description:n.description,roleCounts:n.role_counts??{},entrySummary:(n.entry_summary??[]).map(o=>({index:o.index,role:o.role,timestamp:o.timestamp,contentLength:o.content_length,hasThinking:o.has_thinking,hasToolUse:o.has_tool_use,hasToolResult:o.has_tool_result,preview:o.preview})),totalEntries:n.total_entries??0,totalContentBytes:n.total_content_bytes??0,returnedSummaries:n.returned_summaries??0}}async openIn(e,s){return this._api.openIn(e,s)}async getOpenInApps(){return this._api.getOpenInApps()}async search(e){return this._api.search(e)}async semanticSearch(e){return this._api.semanticSearch(e)}async getResumeCommand(e){return this._api.getResumeCommand(e)}async execResumeSession(e){return this._api.execResumeSession(e)}async getIndexerHealth(){return this._api.getIndexerHealth()}async getIndexerStatus(){return this._api.getIndexerStatus()}async getInfo(){return this._api.getInfo()}async getStats(){return this._api.getStats()}async getTeams(){return this._api.getTeams()}async getTeam(e){return this._api.getTeam(e)}async getTeamMemberMessages(e,s){return this._api.getTeamMemberMessages(e,s)}async getTeamTasks(e){return this._api.getTeamTasks(e)}async getThemes(){return this._api.getThemes()}async*streamSessionEntries(e,s,n){for await(const i of this._api.streamSessionEntries(e,s,n))yield G(i)}async getAllSessionEntries(e,s,n){const i=[];for await(const r of this.streamSessionEntries(e,s,n))i.push(r);return i}}let B=null;function Ie(){return B||(B=new Ce),B}const k=Ie();function Me(){const t=window.location.hash;if(!t)return;const s=new URLSearchParams(t.slice(1)).get("token")??void 0;return s&&window.history.replaceState(null,"",window.location.pathname),s}const K=Me();k.setConfig({baseUrl:"",...K?{token:K}:{}});function Ee(t,e){const s=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(s),i=document.createElement("a");i.href=n,i.download=t,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(n)}function Le(t){return t=t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),t.replace(/("(\\u[a-zA-Z0-9]{4}|\\[^u]|[^\\"])*"(\s*:)?|\b(true|false|null)\b|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)/g,function(e){let s="json-number";return/^"/.test(e)?/:$/.test(e)?s="json-key":s="json-string":/true|false/.test(e)?s="json-boolean":/null/.test(e)&&(s="json-null"),'<span class="'+s+'">'+e+"</span>"})}async function X(t){try{return await navigator.clipboard.writeText(t),!0}catch(e){return console.error("Failed to copy to clipboard",e),!1}}function ee(t){const e=t.toLowerCase();return["claude","kimi","gemini","codex","copilot","qwen"].includes(e)?`color: var(--source-${e}-color); background: var(--source-${e}-bg); border: 1px solid var(--source-${e}-color);`:"color: var(--text-secondary); background: var(--border-color);"}function P(t,e,s,n="Loading..."){t.innerHTML=`
        <div class="panel">
    ...
    `;if(e)e.innerHTML=i;else{const l=document.createElement("div");l.style.cssText="display: flex; justify-content: flex-end; margin-bottom: 1rem;",l.innerHTML=i,t.insertBefore(l,t.firstChild)}const r=document.getElementById(`${s}-list`),o=document.getElementById(`${s}-json-container`),c=(e||t).querySelectorAll(".tab-btn"),a=t.querySelectorAll(".tab-content");return c.forEach(l=>{l.addEventListener("click",u=>{const p=u.target.getAttribute("data-target");c.forEach(g=>g.classList.remove("active")),u.target.classList.add("active"),a.forEach(g=>{g.classList.remove("active"),g.id===p&&g.classList.add("active")})})}),{listContainer:r,jsonContainer:o,setError:l=>{r&&(r.innerHTML=`<div class="error">${l}</div>`),o&&(o.innerHTML=`<div class="error">${l}</div>`)}}}function U(t,e){const s=e.filename.replace(/[^a-zA-Z0-9]/g,"-");t.innerHTML=`
    ...
    `;const n=document.getElementById(`btn-copy-${s}`);n&&n.addEventListener("click",async()=>{const r=await X(JSON.stringify(e.data,null,2)),o=n.textContent;n.textContent=r?"✅ Copied!":"❌ Failed",setTimeout(()=>{n.textContent=o},2e3)});const i=document.getElementById(`btn-download-${s}`);i&&i.addEventListener("click",()=>{Ee(`${s}.json`,e.data)})}function je(t){const e=new Map;for(const s of t){const n=s.displayPath||s.path||s.id||"",i=`${s.name||""}\0${n}`,r=s.lastModified?new Date(s.lastModified).getTime():0,o=e.get(i);o?(s.source&&!o.sources.includes(s.source)&&o.sources.push(s.source),r>0&&(o.lastModifiedMin=o.lastModifiedMin===0?r:Math.min(o.lastModifiedMin,r),o.lastModifiedMax=Math.max(o.lastModifiedMax,r))):e.set(i,{name:s.name||"",id:s.id||"",path:n,sources:s.source?[s.source]:[],lastModifiedMin:r,lastModifiedMax:r})}return Array.from(e.values())}function Ae(t,e){const s=P(t,e,"projects","Loading projects...");if(e){const r=document.createElement("div");r.className="sort-controls",r.innerHTML=`
        ...
        `,e.insertBefore(r,e.firstChild)}let n="time",i="desc";Promise.all([k.getProjects(),k.getOpenInApps().catch(()=>({apps:[]})),k.getSources().catch(()=>[])]).then(([r,o,c])=>{const a=je(r),l=o.apps||[],u=new Set;for(const v of c)if(v.can_resume||v.canResume){const m=v.name||v.id||"";m&&u.add(m)}function p(v){const m=[...v];return m.sort((y,h)=>{let d=0;if(n==="name")d=y.name.localeCompare(h.name,void 0,{sensitivity:"base"});else{const b=i==="asc"?y.lastModifiedMin:y.lastModifiedMax,$=i==="asc"?h.lastModifiedMin:h.lastModifiedMax;d=b-$}return i==="asc"?d:-d}),m}function g(){if(!s.listContainer)return;const v=p(a);if(v.length===0){s.listContainer.innerHTML='<div style="color: var(--text-secondary);">No projects found.</div>';return}s.listContainer.innerHTML=v.map((m,y)=>{const h=`copy-${y}`,d=`open-in-${y}`,b=m.sources.map(x=>`<span class="badge" style="${ee(x)}">${x}</span>`).join(""),$=m.lastModifiedMax,M=$>0?new Date($).toLocaleString(void 0,{dateStyle:"medium",timeStyle:"short"}):"",E=m.sources.filter(x=>u.has(x)),j=E.length>0?"<option disabled>──────────</option>"+E.map(x=>`<option value="resume:${x}">Resume (${x})</option>`).join(""):"",L=l.filter(x=>x.enabled!==!1),A=L.length>0||E.length>0;return`
                ...
                `}).join(""),v.forEach((m,y)=>{const h=document.getElementById(`copy-${y}`);h&&h.addEventListener("click",async()=>{const b=await X(m.path),$=h.textContent;h.textContent=b?"✅":"❌",setTimeout(()=>{h&&(h.textContent=$)},2e3)});const d=document.getElementById(`open-in-${y}`);d&&d.addEventListener("change",async()=>{const b=d.value;if(b)try{if(d.disabled=!0,b.startsWith("resume:")){const $=b.slice(7),M=await k.getSessions(m.id,$);if(M.length===0){alert(`No sessions found for ${$} in this project.`);return}M.sort((L,A)=>{const x=L.modifiedAt?new Date(L.modifiedAt).getTime():0;return(A.modifiedAt?new Date(A.modifiedAt).getTime():0)-x});const E=M[0],j=E.fullPath||E.full_path||"";if(!j){alert("Could not determine session path for resume.");return}await k.execResumeSession(j)}else await k.openIn(b,m.path)}catch($){console.error("Action failed:",$),alert(`Failed: ${$.message||"Unknown error"}`)}finally{d.value="",d.disabled=!1}})})}if(e){const v=e.querySelectorAll("[data-sort-field]"),m=e.querySelector("[data-sort-dir]");v.forEach(y=>{y.addEventListener("click",()=>{n=y.getAttribute("data-sort-field"),v.forEach(h=>h.classList.remove("active")),y.classList.add("active"),g()})}),m&&m.addEventListener("click",()=>{i=i==="asc"?"desc":"asc",m.textContent=i==="asc"?"↑":"↓",m.setAttribute("data-sort-dir",i),g()})}g(),s.jsonContainer&&U(s.jsonContainer,{data:r,filename:"projects",url:"/api/v1/projects"})}).catch(r=>{s.setError(`Failed to load projects: ${r.message}`)})}function Pe(t,e){const s=P(t,e,"sources","Loading sources...");k.getSources().then(n=>{s.listContainer&&(n.length===0?s.listContainer.innerHTML='<div style="color: var(--text-secondary);">No sources found.</div>':s.listContainer.innerHTML=n.map(i=>`
                        <div class="list-item">
                            <div>
                    ...
                    `).join("")),s.jsonContainer&&U(s.jsonContainer,{data:n,filename:"sources",url:"/api/v1/sources"})}).catch(n=>{s.setError(`Failed to load sources: ${n.message}`)})}function I(t){return t===void 0?"—":t.toLocaleString()}function Z(t){if(t===void 0)return"—";if(t<60)return`${t}s`;const e=Math.floor(t/3600),s=Math.floor(t%3600/60);return e>0?`${e}h ${s}m`:`${s}m`}function _(t,e,s,n){return`
    ...
    `}function Y(t,e){if(t===void 0||e===void 0||e===0)return"";const s=Math.min(100,Math.round(t/e*100));return`
  ...
  `;const s=document.getElementById("dashboard-connection"),n=document.getElementById("dashboard-stats"),i=document.getElementById("dashboard-server-info"),r=document.getElementById("dashboard-indexer");k.getSources().then(()=>{s&&(s.classList.remove("loading"),s.innerHTML='<span class="source-status online">Online</span>')}).catch(o=>{s&&(s.classList.remove("loading"),s.innerHTML=`<span class="source-status offline" title="${o.message}">Offline</span>`)}),k.getStats().then(o=>{if(!n)return;const c=(o.top_tools||[]).sort((a,l)=>(l.count||0)-(a.count||0)).slice(0,10);n.innerHTML=`
                ...
                ${c.length>0?`
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                        ${c.map((a,l)=>{const u=c[0].count||1,p=Math.round((a.count||0)/u*100);return`
                                <div style="display: flex; align-items: center; gap: 1rem;">
                                    ...
                                    <div style="flex: 1; background: var(--border-color); border-radius: 999px; height: 8px; overflow: hidden;">
                                        <div style="background: var(--accent-color); width: ${p}%; height: 100%; border-radius: 999px;"></div>
                                    </div>
            ...
            `}).catch(o=>{n&&(n.innerHTML=`<div class="error">Failed to load stats: ${o.message}</div>`)}),k.getInfo().then(o=>{i&&(i.innerHTML=`
                <div style="display: flex; flex-wrap: wrap; gap: 1rem; margin-bottom: 1.5rem;">
                    ${_("🏷️","Version",o.version||"—",o.revision?`<span style="font-family: 'IBM Plex Mono', monospace;">${o.revision.substring(0,7)}</span>`:void 0)}
                    ${_("⏱","Uptime",Z(o.uptime_seconds))}
                    ${_("🔑","Auth",o.authenticated?"Enabled":"Disabled")}
                    ${_("⚙️","PID",o.pid||"—")}
                </div>
            `)}).catch(o=>{i&&(i.innerHTML=`<div style="color: var(--text-secondary);">Server info unavailable: ${o.message}</div>`)}),k.getIndexerStatus().then(o=>{if(!r)return;const c=o.running?"var(--success-color)":"var(--text-secondary)",a=o.sync_progress,l=o.embed_progress;r.innerHTML=`
                <div style="display: flex; flex-wrap: wrap; gap: 1rem; margin-bottom: 1.5rem;">
                    ${_("🧠","Model",o.model||"—",o.model_dim?`${o.model_dim}d`:void 0)}
                    ${_("⏱","Uptime",Z(o.uptime_seconds))}
                    ${_("📡","Watching",o.watching?"Yes":"No")}
                    ${_("⚙️","State","",`<span style="color: ${c}; font-size: 0.9rem; font-weight: 600;">${o.state||(o.running?"Running":"Idle")}</span>`)}
                </div>
                ...
                ${a?`
                    <div style="margin-bottom: 1rem;">
                        ...
                        ${Y(a.done,a.total)}
                        ${a.project_name?`<div style="font-size: 0.75rem; color: var(--text-secondary); margin-top: 0.35rem;">Project: ${a.project_name}</div>`:""}
                    </div>
                `:""}
                ...
                ${l?`
                    <div>
                        ...
                        ${l.message?`<div style="font-size: 0.85rem; color: var(--text-secondary); margin-bottom: 0.25rem;">${l.message}</div>`:""}
                        ${Y(l.done,l.total)}
                    </div>
                `:""}

                ${!a&&!l?'<div style="color: var(--text-secondary); font-size: 0.875rem;">No active sync or embedding in progress.</div>':""}
            `}).catch(o=>{r&&(r.innerHTML=`<div style="color: var(--text-secondary);">Indexer status unavailable: ${o.message}</div>`)})}function Be(t,e){const s=P(t,e,"apps","Loading apps...");k.getOpenInApps().then(n=>{const i=n.apps||[],r=n.default_terminal;if(s.listContainer)if(i.length===0){s.listContainer.innerHTML='<div style="color: var(--text-secondary);">No apps configured.</div>';return}else s.listContainer.innerHTML=i.map(o=>{const c=[];if(o.terminal){const a=o.id===r;c.push('<span class="badge" style="background: rgba(20, 184, 166, 0.12); border: 1px solid rgba(20, 184, 166, 0.35); color: #2dd4bf;" title="Terminal App">terminal</span>'),a&&c.push('<span class="badge" style="background: rgba(245, 158, 11, 0.15); border: 1px solid rgba(245, 158, 11, 0.4); color: #fbbf24;" title="Default Terminal">★ default</span>')}return`
                        <div class="list-item">
                            <div>
                                <div class="list-item-title" style="display: flex; align-items: center; gap: 0.5rem;">
                                    ${o.name}
    ...
    `}function Oe(t,e){const s=P(t,e,"themes","Loading themes...");k.getThemes().then(n=>{const i=(n.themes||[]).sort((r,o)=>r.active&&!o.active?-1:!r.active&&o.active?1:(r.name||"").localeCompare(o.name||""));s.listContainer&&(i.length===0?s.listContainer.innerHTML='<div style="color: var(--text-secondary);">No themes found.</div>':(s.listContainer.innerHTML=`
                        <p style="color: var(--text-secondary); font-size: 0.9rem; margin-bottom: 1rem;">
                            Preview the available themes from the connected Thinkt API.
                        </p>
                    `,i.forEach((r,o)=>{const c=document.createElement("div");c.style.marginBottom="0.75rem";const a=document.createElement("div");a.className="list-item",a.style.cursor="pointer",a.style.background="var(--bg-color)",a.style.borderRadius="6px",a.style.border="1px solid var(--border-color)",a.innerHTML=`
                            <div>
                                <div class="list-item-title" style="display: flex; align-items: center; gap: 0.5rem;">
                                    ${r.name||"Unnamed"}
                        ...
                        `;const l=document.createElement("div");l.id=`theme-preview-${o}`,l.style.display="none",l.style.marginTop="0.5rem";let u=!1;a.addEventListener("click",()=>{const p=l.style.display==="none";l.style.display=p?"block":"none",a.querySelector(".toggle-icon").textContent=p?"▲":"▼",p&&!u&&r.colors&&(Re(l,r.colors,r.name||"Unnamed"),u=!0)}),c.appendChild(a),c.appendChild(l),s.listContainer.appendChild(c),r.active&&a.click()}))),s.jsonContainer&&U(s.jsonContainer,{data:n,filename:"themes",url:"/api/v1/themes"})}).catch(n=>{s.setError(`Failed to load themes: ${n.message}`)})}const Q=document.getElementById("app");if(Q){let t=function(r){if(!s||!n)return;const o=document.getElementById("header-controls");switch(o&&(o.innerHTML=""),e.forEach(c=>{var a;c.classList.remove("active"),c.getAttribute("data-view")===r&&(c.classList.add("active"),s.textContent=((a=c.textContent)==null?void 0:a.trim())||r)}),n.innerHTML="",r){case"dashboard":Ue(n);break;case"projects":Ae(n,o);break;case"sources":Pe(n,o);break;case"apps":Be(n,o);break;case"themes":Oe(n,o);break;default:n.innerHTML=`<div class="error">View "${r}" not implemented yet</div>`}};Q.innerHTML=`
    <nav class="sidebar">
